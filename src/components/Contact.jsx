...
function Contact() {
  return (
    <div className='w-full h-auto py-20 bg-white flex items-center justify-center'>
        <div>
            <p className='text-md text-orange-600 font-bold py-6'>CONTACT</p>
            <div className='flex'>
                <div className='border px-10 py-2 mr-4 flex items-center'>
